# This script assumes that the samples of KREED-XL have been generated in 12 partitions of the test set of QM9, as specified in make_jobs.py
...
all_results = dict()
import tqdm
for k in tqdm.trange(12):
    out = torch.load(f"{samples_path}/qm9_{k}.pt")
